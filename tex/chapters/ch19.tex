...
\textbf{Library implementation:} \texttt{cuckoo\_filter.h} provides \texttt{insert}, \texttt{contains}, and \texttt{erase}; insertion can fail when the configured table is full.
...
\textbf{Library implementation:} \texttt{heavy\_hitters.h} provides bounded-space candidate tracking via \texttt{dsa::misra\_gries}; a second pass is needed for exact frequencies.
