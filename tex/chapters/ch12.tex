...
\textbf{Library implementation:} \texttt{graph.h} exposes \texttt{g.articulation\_points()} and \texttt{g.bridges()} for undirected simple graphs.
...
\textbf{Library implementation:} \texttt{a\_star.h} provides \texttt{dsa::a\_star(g, start, goal, heuristic)} with optional path reconstruction.
